...
// TODO: 본인이 작성한 Q&A인 경우에만 [수정], [삭제] 버튼 노출
// TODO: 수정, 삭제 API 연결
// TODO: 비공개인 경우 상세 페이지 진입 불가 Alert 노출
    ...
    return (
        <Container component="main" maxWidth="md" sx={{ marginTop: 4, marginBottom: 4 }}>
            ...
            <Grid container spacing={2} sx={{marginTop: '30px'}}>
                <Grid xs={4}></Grid>
                <Grid xs={2}>
                    <Button sx={{ml: 1}} variant="contained" size="small" fullWidth>수정</Button>
                </Grid>
                <Grid xs={2}>
                    <Button sx={{ml: 1}} variant="contained" color="error" size="small" fullWidth>삭제</Button>
                </Grid>
            </Grid>
        </Container>
    );
